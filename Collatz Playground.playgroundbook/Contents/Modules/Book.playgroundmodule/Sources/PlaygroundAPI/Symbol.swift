...
public class Symbol {
    ...
    /// - Parameter shape: The type of shape. The default value is .circle.
    /// - Parameter size: The size of the shape. The default value is 8.0.
    /// - localizationKey: Symbol(shape:size)
    ...
    /// - Parameter imageName: The name of the image in this playground’s resources.
    /// - Parameter size: The size of the image. The default value is 32.0.
    /// - localizationKey: Symbol(imageNamed)
