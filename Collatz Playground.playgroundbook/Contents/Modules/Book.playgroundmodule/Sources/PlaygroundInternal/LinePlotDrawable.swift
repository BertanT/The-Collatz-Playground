...
internal protocol LineData: CustomPlaygroundDisplayConvertible {
...
extension DiscreteLineData: CustomPlaygroundDisplayConvertible {
    public var playgroundDescription: Any {
        get {
            let numPoints = xyData.count
            let suffix = numPoints == 1 ? "point" : "points"
            return "\(numPoints) \(suffix)"
        }
    }
}
...
extension FunctionLineData: CustomPlaygroundDisplayConvertible {
    public var playgroundDescription: Any {
        get {
