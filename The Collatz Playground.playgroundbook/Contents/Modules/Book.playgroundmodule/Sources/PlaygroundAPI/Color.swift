...
public class Color: _ExpressibleByColorLiteral, Equatable {
    ...
    public static let purple: Color = Color(UIColor(named: "linePurple") ?? #colorLiteral(red: 0.2666243911, green: 0.1584459841, blue: 0.7177972794, alpha: 1))
    public static let pink: Color   = Color(UIColor(named: "linePink") ?? #colorLiteral(red: 0.7086744905, green: 0.05744680017, blue: 0.5434997678, alpha: 1))
    public static let green: Color  = Color(UIColor(named: "lineGreen") ?? #colorLiteral(red: 0.07005243003, green: 0.5545874834, blue: 0.1694306433, alpha: 1))
    public static let blue: Color   = Color(UIColor(named: "lineBlue") ?? #colorLiteral(red: 0, green: 0.1771291047, blue: 0.97898072, alpha: 1))
