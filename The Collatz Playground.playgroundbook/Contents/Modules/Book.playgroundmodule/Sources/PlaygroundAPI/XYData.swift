...
public class XYData {
    ...
    /// - Parameter yData: The color to use for symbols and lines.
    /// - Parameter startingX: The x value to start the data at. The default value is 0.0.
    /// - Parameter xStride: The difference between one x value and the next. The default value is 1.0.
    /// - localizationKey: XYData(yData:startingX:xStride:)
    ...
    /// - localizationKey: XYData.append(x:y:)
    ...
    /// - localizationKey: XYData.append(y:)
